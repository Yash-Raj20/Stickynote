...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Expandable Sidebar */}
      <aside className={`
        fixed md:absolute left-0 top-0 h-full w-[280px] md:w-16 md:hover:w-64
      ...
      `}>
        ...
        <div className="pt-12 pb-2 px-3 flex flex-col gap-2 w-full whitespace-nowrap">
          {/* Add Note / Frame */}
          <div className="flex flex-col gap-2 w-full">
            <button
              onClick={handleAddNote}
              className="w-full h-10 rounded-xl bg-theme-secondary hover:bg-theme-primary/25 text-theme-primary flex items-center px-[10px] gap-4 transition-transform active:scale-95 shadow-sm group/btn"
              title="Add Note"
            >
            ...
            <button
              ...
              className="w-full h-10 rounded-xl border border-border hover:bg-black/5 dark:hover:bg-white/5 text-foreground flex items-center px-[10px] gap-4 transition-transform active:scale-95 shadow-sm group/btn"
              title="Add Frame"
            >
              <Frame size={20} className="shrink-0 opacity-70" />
            ...
            <div className="relative">
              <button
                ...
                className="w-full h-10 rounded-xl border border-dashed border-border hover:border-theme-primary/50 hover:bg-theme-secondary/30 text-foreground/60 hover:text-theme-primary flex items-center px-[10px] gap-4 transition-all active:scale-95 group/btn"
                title="Save board as template"
              >
                <BookmarkPlus size={20} className="shrink-0" />
        ...
        {/* Navigation Links */}
        <div className="flex flex-col gap-2 px-3 w-full flex-1 whitespace-nowrap overflow-hidden">
          <Link onClick={() => setIsSidebarOpen(false)} href="/board" className={`w-full h-10 rounded-xl flex items-center px-[10px] gap-4 transition-colors group/btn shadow-sm ${pathname === '/board' ? 'bg-theme-secondary text-theme-primary' : 'text-foreground/60 hover:bg-input-bg hover:text-foreground'}`}>
          ...
          <Link onClick={() => setIsSidebarOpen(false)} href="/board/templates" className={`w-full h-10 rounded-xl flex items-center px-[10px] gap-4 transition-colors group/btn shadow-sm ${pathname === '/board/templates' ? 'bg-theme-secondary text-theme-primary' : 'text-foreground/60 hover:bg-input-bg hover:text-foreground'}`}>
          ...
          <Link onClick={() => setIsSidebarOpen(false)} href="/board/archived" className={`w-full h-10 rounded-xl flex items-center px-[10px] gap-4 transition-colors group/btn shadow-sm ${pathname === '/board/archived' ? 'bg-theme-secondary text-theme-primary' : 'text-foreground/60 hover:bg-input-bg hover:text-foreground'}`}>
          ...
          <Link onClick={() => setIsSidebarOpen(false)} href="/board/trashed" className={`w-full h-10 rounded-xl flex items-center px-[10px] gap-4 transition-colors group/btn shadow-sm ${pathname === '/board/trashed' ? 'bg-theme-secondary text-theme-primary' : 'text-foreground/60 hover:bg-input-bg hover:text-foreground'}`}>
          ...
          <Link onClick={() => setIsSidebarOpen(false)} href="/board/shared" className={`w-full h-10 rounded-xl flex items-center px-[10px] gap-4 transition-colors group/btn shadow-sm ${pathname === '/board/shared' ? 'bg-theme-secondary text-theme-primary' : 'text-foreground/60 hover:bg-input-bg hover:text-foreground'}`}>
        ...
        {/* Footer */}
        <div className="flex flex-col gap-2 px-3 pb-6 pt-4 w-full whitespace-nowrap overflow-hidden">
          <button className="w-full h-10 rounded-xl text-foreground/60 hover:bg-input-bg hover:text-foreground flex items-center px-[10px] gap-4 transition-colors">
          ...
          <button onClick={handleLogout} className="w-full h-10 rounded-xl text-foreground/60 hover:bg-red-50 hover:text-red-500 flex items-center px-[10px] gap-4 transition-colors">
